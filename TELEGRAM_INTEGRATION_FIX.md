...
curl -X POST https://6581c3df0afd.ngrok-free.app/api/webhooks/set/customer \
  -H "Content-Type: application/json" \
  -d '{"url": "https://e8fe924f5faa.ngrok-free.app/api/webhooks/telegram/customer"}'

# Set delivery bot webhook
curl -X POST https://e8fe924f5faa.ngrok-free.app/api/webhooks/set/delivery \
  -H "Content-Type: application/json" \
  -d '{"url": "https://6581c3df0afd.ngrok-free.app/api/webhooks/telegram/delivery"}'
```
...
curl https://6581c3df0afd.ngrok-free.app/api/webhooks/info/customer

# Check delivery bot webhook
curl https://6581c3df0afd.ngrok-free.app/api/webhooks/info/delivery
```
...
```bash
curl -X OPTIONS https://6581c3df0afd.ngrok-free.app/api/auth/telegram \
  -H "Origin: https://z7tdksrvcs.eu.loclx.io" \
...
```bash
curl -X POST https://6581c3df0afd.ngrok-free.app/api/auth/telegram \
  -H "Origin: https://z7tdksrvcs.eu.loclx.io" \
  -H "Content-Type: application/json" \
  -d '{
