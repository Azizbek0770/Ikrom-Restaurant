...
curl -X POST https://ce051dc56fd3.ngrok-free.app/api/webhooks/set/customer \
  -H "Content-Type: application/json" \
  -d '{"url": "https://ce051dc56fd3.ngrok-free.app/api/webhooks/telegram/customer"}'

# Set delivery bot webhook
curl -X POST https://ce051dc56fd3.ngrok-free.app/api/webhooks/set/delivery \
  -H "Content-Type: application/json" \
  -d '{"url": "https://ce051dc56fd3.ngrok-free.app/api/webhooks/telegram/delivery"}'
```
...
curl https://ce051dc56fd3.ngrok-free.app/api/webhooks/info/customer

# Check delivery bot webhook
curl https://ce051dc56fd3.ngrok-free.app/api/webhooks/info/delivery
```
