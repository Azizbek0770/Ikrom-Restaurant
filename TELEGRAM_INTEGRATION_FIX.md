...
curl -X POST https://8d859de02dae.ngrok-free.app/api/webhooks/set/customer \
  -H "Content-Type: application/json" \
  -d '{"url": "https://8d859de02dae.ngrok-free.app/api/webhooks/telegram/customer"}'

# Set delivery bot webhook
curl -X POST https://8d859de02dae.ngrok-free.app/api/webhooks/set/delivery \
  -H "Content-Type: application/json" \
  -d '{"url": "https://8d859de02dae.ngrok-free.app/api/webhooks/telegram/delivery"}'
```
...
curl https://8d859de02dae.ngrok-free.app/api/webhooks/info/customer

# Check delivery bot webhook
curl https://8d859de02dae.ngrok-free.app/api/webhooks/info/delivery
```
...
```bash
curl -X OPTIONS https://8d859de02dae.ngrok-free.app/api/auth/telegram \
  -H "Origin: https://4j97heo1vq.eu.loclx.io" \
...
```bash
curl -X POST https://8d859de02dae.ngrok-free.app/api/auth/telegram \
  -H "Origin: https://4j97heo1vq.eu.loclx.io" \
  -H "Content-Type: application/json" \
  -d '{
